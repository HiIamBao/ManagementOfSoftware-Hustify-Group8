...
const generateMermaidDiagram = (nodes: RoadmapNode[]): string => {
  ...
  diagram += ` classDef yellow fill:#E5D0AC,stroke:#333,stroke-width:2px,color:#000,font-size:24px\n`;
  diagram += ` classDef clickable fill:#E5D0AC,stroke:#333,stroke-width:2px,color:#000,font-size:24px,cursor:pointer\n`;
  return diagram;
};
