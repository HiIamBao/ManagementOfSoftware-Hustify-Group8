...
import OtherUserProfileHeader from "@/components/otheruser/OtherUserProfileHeader";
import OtherUserInfoBox from "@/components/otheruser/OtherUserInfoBox";
import OtherUserSkills from "@/components/otheruser/OtherUserSkills";
      ...
      <div className="w-full max-w-7xl flex flex-row gap-8">
        <div className="flex-1 min-w-0 pl-10">
          ...
          <div className="w-full flex flex-col gap-6 mt-10">
            ...
            <OtherUserExperience user={user} />
            <OtherUserEducation user={user} />
          </div>
        </div>
