...
const Agent = ({
  ...
  return (
    <>
      <div className="call-view pl-10 pr-10 pb-5">
        {/* AI Interviewer Card */}
        <div className="card-interviewer border-[3.5] border-[#121212] dark:border-white">
        ...
        {/* User Profile Card */}
        <div className="p-0.5 rounded-2xl flex-1 sm:basis-1/2 w-full h-[400px] max-md:hidden border-[3.5] border-[#121212] dark:boder-white">
          <div className="card-content">
            <Image
              ...
              width={539}
              height={539}
              className="rounded-full object-cover size-[120px] border-3 p-1 border-black dark:border-white"
            />
            <h3 className="text-gray-700 dark:text-white">{userName}</h3>
          </div>
        </div>
      </div>
